...
exports.get = function(key) {
    ...
    //console.log("1111111",internals.store.get(key, internals.criteria));
    console.log('internals',internals);
    return internals.store.get(key, internals.criteria);
};

exports.meta = function(key) {
    console.log('internals.store.meta',internals.store.meta);
    console.log('internals.store.meta(key, internals.criteria);',internals.store.meta(key, internals.criteria));
